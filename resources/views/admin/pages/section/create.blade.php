...
@section('content')
    ...
    <section class="content">
                    ...
                    <div class="card">
                        <div class="py-3 px-2">
                            ...
                            <a href="#" data-toggle="modal"
                               data-target="#SectionModal">CREATE SECTION</a>
                        </div>
                        <div class="card-body">
                            <div class="container">
        ...
        <!-- /.row -->
        <!-- Modal -->
        <div class="modal fade" aria-hidden="false"  id="SectionModal">
                            ...
                            <div class="row g-3 align-items-center mx-auto">
                                ...
                                <div class="col-8">
                                    <input type="text" name="section_name" id="section_name" class="form-control"
                                           aria-describedby="section_name" placeholder="Enter Class Name">
                                </div>
                            </div>
    ...
    <script>
        myform.onsubmit = async (e) => {
            ...
            try {
                ...
                let response = await axios.post('{{route('section.store')}}', dataForm);
        ...
        function deleteData(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios.delete('/section/destroy/' + id).then(function (response) {
                        console.log(response);
                        getUser()
                    })
