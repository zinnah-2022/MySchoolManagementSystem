                    ...
                    <div class="card">
                        <div class="py-3 px-2">
                            ...
                            <a href="#" data-toggle="modal"
                               data-target="#SESSIONModal">CREATE SESSION</a>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="container">
                                <table id="session" class="table">
                                    ...
                                    <tr>
                                        ...
                                        <th class="th-sm">Session Name</th>
                                        <th class="th-sm">Create Data</th>
                            ...
                            <div class="row g-3 align-items-center mx-auto">
                                ...
                                <div class="col-8">
                                    <input type="text" name="year_name" id="year_name" class="form-control"
                                           aria-describedby="year_name" placeholder="Enter section Name">
                                </div>
                            </div>
    ...
    <script>
        myform.onsubmit = async (e) => {
            ...
            try {
                ...
                let response = await axios.post('{{route('years.store')}}', dataForm);
            ...
            document.getElementById('modal-default').modal('hide')
        };
        ...
        function deleteData(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios.delete('/years/destroy/' + id).then(function (response) {
                        console.log(response);
                        getUser()
                    })
