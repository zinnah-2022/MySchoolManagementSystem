                    ...
                    <div class="card">
                        <div class="py-3 px-2">
                            ...
                            <a href="#" class="text-success" data-toggle="modal"
                               data-target="#DesignationModal">Create Designation</a>
                        </div>
                        <div class="card-body">
                            <div class="container">
                    ...
                    <form id="myform">
                        <div class="modal-body">
                            <div class="row g-3 align-items-center mx-auto">
                                <div class="col-auto">
                                    <label for="inputPassword6" class="col-form-label">Designation Name: </label>
                                </div>
                                <div class="col-8">
                                    <input type="text" name="designation_name" id="designation_name" class="form-control"
                                           aria-describedby="designation_name" placeholder="Enter Class Name">
                                </div>
                            </div>
    ...
    <script>
        myform.onsubmit = async (e) => {
            ...
            try {
                ...
                let response = await axios.post('{{route('designation.store')}}', dataForm);
        ...
        function getUser(){
            let nub=0;
            let view=''
            axios.get('{{route('designation_view')}}')
            ...
            function addData(e){
                ...
                document.getElementById('designation').innerHTML=view;
            }
        }
        function deleteData(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios.delete('/designation/destroy/' + id).then(function (response) {
                        console.log(response);
                        getUser()
                    })
