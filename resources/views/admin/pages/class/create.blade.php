                    ...
                    <div class="card">
                        <div class="py-3 px-2">
                            ...
                            <a href="#" data-toggle="modal"
                               data-target="#ClassModal">CREATE CLASS</a>
                        </div>
                        <div class="card-body">
                            <div class="container">
                            ...
                            <div class="row g-3 align-items-center mx-auto">
                                ...
                                <div class="col-8">
                                    <input type="text" name="class_name" id="class_name" class="form-control"
                                           aria-describedby="class_name" placeholder="Enter Class Name">
                                </div>
                            </div>
    ...
    <script>
        myform.onsubmit = async (e) => {
            ...
            try {
                ...
                let response = await axios.post('{{route('class.store')}}', dataForm);
        ...
        function deleteData(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios.delete('/class/destroy/' + id).then(function (response) {
                        console.log(response);
                        getUser()
                    })
